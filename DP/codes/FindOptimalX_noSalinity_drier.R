...
NofCore <- 11
hyper_par <- list(x0 = numeric(15), P = c(0.25, 0.25, 0.2, 0.2, 0.1), xLB = numeric(15), R = 0.035, INI_P = 12000)
...
sfStop()
save(OptimalX_backup, file = paste0(getwd(), "/results/woSalinity/OptimalX_woSalinity_drier.RData"))
