...
load(paste0(getwd(), "/results/woSalinity/OptimalX_woSalinity_driest.RData"))
...
save(profit_all, k_min, OptimalX_backup,
     file = "/soe/wjzhao/project/Salinity/results/woSalinity/woSalinity_result_driest.RData")
